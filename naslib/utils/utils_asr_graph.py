...
_op_to_node_color = {
    ...
    'conv7d2': 'seagreen4',
    'linear-skip': 'tomato',
    'conv5-skip': 'cadetblue1',
    'conv5d2-skip': 'deepskyblue1',
    'conv7-skip': 'olivedrab2',
    'conv7d2-skip': 'seagreen4',
    # 'zero-skip': 'tomato'
}
...
_op_to_label = {
    ...
    'conv5-skip': 'Conv(5)-skip',
    'conv5d2-skip': 'Conv(5,d=2)-skip',
    'conv7-skip': 'Conv(7)-skip',
    'conv7d2-skip': 'Conv(7,d=2)-skip',
    'zero-skip': 'Zero-skip'
}
