...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_size_single", type=int, default=2, help="Train size if exp type is single")
    parser.add_argument("--fidelity_single", type=int, default=100, help="Fidelity if exp type is single")
