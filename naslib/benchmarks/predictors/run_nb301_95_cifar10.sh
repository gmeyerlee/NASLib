predictors=(seminas xgb gcn bohamiann gp rf mlp)

experiment_types=(vary_train_size vary_train_size vary_train_size vary_train_size vary_train_size vary_train_size vary_train_size)
