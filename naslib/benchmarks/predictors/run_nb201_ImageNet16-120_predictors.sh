<<<<<<< HEAD:naslib/benchmarks/predictors/run_nlp_hyper.sh
predictors=(xgb bohamiann gp rf mlp)

experiment_types=(single single single single single)
=======
predictors=(gp rf mlp bohamiann xgb)
>>>>>>> 32892c560d27426eea433064aa74d80fff5718ce:naslib/benchmarks/predictors/run_nb201_ImageNet16-120_predictors.sh
