...
supported_predictors = {
    ...
    'lcsvr': SVR_Estimator(metric=Metric.VAL_ACCURACY, all_curve=False,
                           require_hyper=False),
    'blr_loss': SVR_Estimator(metric=Metric.TRAIN_LOSS, all_curve=False,
                              require_hyper=True, model_name='blr'),
    'blr_acc': SVR_Estimator(metric=Metric.VAL_ACCURACY, all_curve=False,
                             require_hyper=True, model_name='blr'),    
