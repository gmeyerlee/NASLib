<<<<<<< HEAD:naslib/benchmarks/predictors/run_asr_hyper.sh
predictors=(xgb bohamiann gp rf mlp)

experiment_types=(single single single single single)
=======
predictors=(gp rf mlp bohamiann xgb)
>>>>>>> 32892c560d27426eea433064aa74d80fff5718ce:naslib/benchmarks/predictors/run_nb201_cifar10_predictors.sh
