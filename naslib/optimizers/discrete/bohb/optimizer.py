...
class BOHBSimple(MetaOptimizer):
    ...
    def __init__(self, config):
        ...
        # print('rounds: {}'.format(self.rounds[::-1]))
        # print('round_sizes: {}'.format(self.round_sizes))
        # print('fidelities: {}'.format(self.fidelities))
        # print('total epochs per round: {}'.format([sum(epochs) for epochs in self.round_sizes]))
    ...
    def adapt_search_space(self, search_space, scope=None, dataset_api=None):
        ...
        self.max_training_epoch = self.search_space.max_epoch
    ...
    def fit_kde(self, round):
        ...
        print("good enc shape: {}".format(good_enc.shape))
        print("bad enc shape: {}".format(bad_enc.shape))
        print(len(self.kde_vartypes))
